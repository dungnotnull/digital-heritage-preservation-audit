# -*- coding: utf-8 -*-
"""knowledge_updater.py — self-improving crawler for the Digital Cultural Heritage Preservation Assessment skill.
...
SKILL_ID = 97
SKILL_SLUG = "digital-heritage-preservation-audit"
BRAIN = os.path.join(os.path.dirname(__file__), "..", "SECOND-KNOWLEDGE-BRAIN.md")

ARXIV_CATEGORIES = ["cs.DL"]
SEARCH_QUERIES = ["digital preservation OAIS fixity", "cultural heritage digitization metadata", "long-term archival format migration"]
SOURCE_URLS = ["https://www.loc.gov/programs/digital-collections-management/", "https://public.ccsds.org", "https://www.dpconline.org", "http://www.digitizationguidelines.gov"]
DOMAIN_KEYWORDS = ["digital preservation OAIS fixity", "cultural heritage digitization metadata", "long-term archival format migration"]
