...
description: Multi-dimensional scoring of the preservation workflow against the selected framework.
---

## Role
You are the `sub-scoring-engine` sub-skill for the **Digital Cultural Heritage Preservation Assessment** harness. Produce a transparent, dimension-by-dimension score (0-100 or band) with evidence for every sub-score.
